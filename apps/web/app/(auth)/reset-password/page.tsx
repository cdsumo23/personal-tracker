  ...
  if (isSuccess) {
    return (
      <div className="space-y-6 text-center">
        ...
        <h1 className="text-2xl font-bold text-slate-100">Password Reset Complete</h1>
        <p className="text-slate-400 text-sm max-w-sm mx-auto">
          Your password has been changed successfully. You will be redirected to the sign-in page in a few seconds.
        </p>
        <div className="pt-2">
          <Link href="/login" className="inline-flex items-center justify-center px-6 py-2.5 rounded-xl bg-slate-800 text-slate-200 border border-slate-700 font-medium text-sm hover:bg-slate-700 transition-colors">
            Go to Login
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-slate-400 mt-1 text-sm">Create a strong new password for your account</p>
      </motion.div>

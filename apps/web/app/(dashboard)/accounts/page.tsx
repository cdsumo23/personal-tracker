...
function AccountCard({
 ...
 return (
 <Card className={cn('group relative hover:border-slate-300 dark:border-slate-700/60 transition-all duration-300 overflow-hidden')}>
 {/* Color accent bar */}
 <div
 ...
 <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100">{account.name}</h3>
 {account.isDefault && (
...
export default function AccountsPage() {
 ...
 <div>
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Account Type</label>
 ...
 />
 <label htmlFor="isDefault" className="text-xs font-semibold text-slate-600 dark:text-slate-300">

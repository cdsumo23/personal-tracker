...
function UserFormModal({ isOpen, onClose, editUser, onSuccess }: UserFormModalProps) {
 ...
 <label className="block text-sm font-medium text-slate-600 dark:text-slate-300">First Name <span className="text-red-400">*</span></label>
 <input
 value={form.firstName}
 onChange={e => set('firstName', e.target.value)}
 placeholder="John"
 className={`w-full py-3 px-4 rounded-xl bg-slate-800 border text-slate-900 dark:text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all ${errors.firstName ? 'border-red-500/80' : 'border-slate-300 dark:border-slate-700'}`}
 />
 {errors.firstName && <p className="text-xs text-red-400">{errors.firstName}</p>}
 </div>
 <div className="space-y-1.5">
 <label className="block text-sm font-medium text-slate-600 dark:text-slate-300">Last Name <span className="text-red-400">*</span></label>
 <input
 value={form.lastName}
 onChange={e => set('lastName', e.target.value)}
 placeholder="Doe"
 className={`w-full py-3 px-4 rounded-xl bg-slate-800 border text-slate-900 dark:text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all ${errors.lastName ? 'border-red-500/80' : 'border-slate-300 dark:border-slate-700'}`}
 />
 ...
 {/* Email */}
 <div className="space-y-1.5">
 <label className="block text-sm font-medium text-slate-600 dark:text-slate-300">Email Address <span className="text-red-400">*</span></label>
 <input
 type="email"
 value={form.email}
 onChange={e => set('email', e.target.value)}
 placeholder="john@example.com"
 className={`w-full py-3 px-4 rounded-xl bg-slate-800 border text-slate-900 dark:text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all ${errors.email ? 'border-red-500/80' : 'border-slate-300 dark:border-slate-700'}`}
 />
 ...
 {isEdit ? 'New Password (leave blank to keep current)' : 'Password'} {!isEdit && <span className="text-red-400">*</span>}
 </label>
 ...
 className={`w-full py-3 pl-4 pr-11 rounded-xl bg-slate-800 border text-slate-900 dark:text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all ${errors.password ? 'border-red-500/80' : 'border-slate-300 dark:border-slate-700'}`}
 />
 <button
 type="button"
 onClick={() => setShowPassword(!showPassword)}
 className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:text-slate-200 transition-colors"
 >
 ...
 className="w-full py-3 px-4 rounded-xl bg-slate-800 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
 />
 </div>
 <div className="space-y-1.5">
 <label className="block text-sm font-medium text-slate-600 dark:text-slate-300">Country</label>
 <input
 value={form.country}
 ...
 : 'bg-slate-800 border border-slate-300 dark:border-slate-700 text-slate-500 hover:text-slate-600 dark:text-slate-300'
 }`}
 >
 {r}
 </button>
 ...
 className={`relative w-10 h-5 rounded-full transition-colors cursor-pointer ${form.isActive ? 'bg-emerald-500' : 'bg-slate-700'}`}
 >
 ...
 className={`relative w-10 h-5 rounded-full transition-colors cursor-pointer ${form.isVerified ? 'bg-sky-500' : 'bg-slate-700'}`}
 >
...
export default function AdminPage() {
 ...
 {[1, 2, 3].map((n) => <Card key={n} className="h-28 bg-slate-50 dark:bg-slate-800/40 border border-slate-300 dark:border-slate-700" />)}
 </div>
 ) : (
 ...
 <p className="text-2xl font-extrabold text-slate-800 dark:text-slate-200">{statsQuery.data?.totalUsers || 0}</p>
 </div>
 </Card>
 ...
 <p className="text-2xl font-extrabold text-slate-800 dark:text-slate-200">{statsQuery.data?.totalTransactions || 0}</p>
 </div>
 </Card>
 ...
 <Card className="p-6">
 <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200 mb-4">Server & Service Health</h3>
 ...
 className="w-full py-2.5 pl-9 pr-9 rounded-xl bg-slate-800 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-slate-100 placeholder-slate-500 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
 />
 {search && (
 <button onClick={() => setSearch('')} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:text-slate-200">
 <X className="w-4 h-4" />
 </button>
 )}
 </div>
 ...
 <thead>
 <tr className="border-b border-slate-200 dark:border-slate-800 bg-slate-950/30">
 ...
 <div>
 <p className="font-semibold text-slate-800 dark:text-slate-200 text-[13px]">{u.firstName} {u.lastName}</p>
 ...
 {u.isActive ? (
 <><CheckCircle className="w-3.5 h-3.5 text-emerald-400" /><span className="text-emerald-400 font-semibold">Active</span></>
 ) : (
 <><AlertCircle className="w-3.5 h-3.5 text-amber-400" /><span className="text-amber-400 font-semibold">Suspended</span></>
 )}
 {u.isVerified && <span className="ml-1.5 text-sky-400 text-[10px] font-bold bg-sky-400/10 px-1.5 py-0.5 rounded-full">VERIFIED</span>}
 </div>
 </td>
 ...
 title="Edit user"
 className="p-1.5 rounded-lg text-slate-500 dark:text-slate-400 hover:text-primary-400 hover:bg-primary-500/10 transition-colors"
 >
 ...
 u.isActive
 ? 'text-slate-500 dark:text-slate-400 hover:text-amber-400 hover:bg-amber-400/10'
 : 'text-slate-500 dark:text-slate-400 hover:text-emerald-400 hover:bg-emerald-400/10'
 }`}
 >
 ...
 title="Delete user"
 className="p-1.5 rounded-lg text-slate-500 dark:text-slate-400 hover:text-red-400 hover:bg-red-400/10 transition-colors"
 >
 ...
 {[...Array(6)].map((_, i) => <div key={i} className="h-10 bg-slate-800 rounded-xl" />)}
 </div>
 ) : auditLogs.length === 0 ? (
 <div className="p-16 text-center">
 ...
 {log.user ? (
 <span className="text-slate-600 dark:text-slate-300 font-semibold">{log.user.firstName} {log.user.lastName}</span>
 ) : (
 ...
 <div>
 <span className="text-slate-600 dark:text-slate-300 font-semibold">{log.entity}</span>
 <p className="text-slate-600 text-[10px] truncate max-w-[120px]">{log.entityId}</p>
 </div>
 </td>

      ...
      <form onSubmit={handleSubmit} className="space-y-5 pt-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            <label className="block text-sm font-medium text-slate-300">First Name <span className="text-red-400">*</span></label>
            <input
              value={form.firstName}
              onChange={e => set('firstName', e.target.value)}
              placeholder="John"
              className={`w-full py-3 px-4 rounded-xl bg-slate-800 border text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all ${errors.firstName ? 'border-red-500/80' : 'border-slate-700'}`}
            />
            {errors.firstName && <p className="text-xs text-red-400">{errors.firstName}</p>}
          </div>
          <div className="space-y-1.5">
            <label className="block text-sm font-medium text-slate-300">Last Name <span className="text-red-400">*</span></label>
            <input
              value={form.lastName}
              onChange={e => set('lastName', e.target.value)}
              placeholder="Doe"
              className={`w-full py-3 px-4 rounded-xl bg-slate-800 border text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all ${errors.lastName ? 'border-red-500/80' : 'border-slate-700'}`}
            />
        ...
        {/* Email */}
        <div className="space-y-1.5">
          <label className="block text-sm font-medium text-slate-300">Email Address <span className="text-red-400">*</span></label>
          <input
            type="email"
            value={form.email}
            onChange={e => set('email', e.target.value)}
            placeholder="john@example.com"
            className={`w-full py-3 px-4 rounded-xl bg-slate-800 border text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all ${errors.email ? 'border-red-500/80' : 'border-slate-700'}`}
          />
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <input
              ...
              className={`w-full py-3 pl-4 pr-11 rounded-xl bg-slate-800 border text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all ${errors.password ? 'border-red-500/80' : 'border-slate-700'}`}
            />
            <button
              type="button"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full py-3 px-4 rounded-xl bg-slate-800 border border-slate-700 text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
            />
          </div>
          <div className="space-y-1.5">
        ...
        {/* Role & Toggles */}
        <div className="flex flex-col sm:flex-row gap-4 p-4 rounded-xl bg-slate-800/40 border border-slate-800">
          <div className="flex-1 space-y-1.5">
            <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide">Role</label>
        ...
        <div className="space-y-6">
          {statsQuery.isLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-pulse">
              {[1, 2, 3].map((n) => <Card key={n} className="h-28 bg-slate-800/40 border border-slate-700" />)}
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <Card className="p-5 border-slate-800 bg-slate-900/60 backdrop-blur-md flex items-center space-x-4 hover:border-violet-500/30 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-2xl font-extrabold text-slate-200">{statsQuery.data?.totalUsers || 0}</p>
                </div>
              </Card>
              <Card className="p-5 border-slate-800 bg-slate-900/60 backdrop-blur-md flex items-center space-x-4 hover:border-emerald-500/30 transition-colors">
                <div className="p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400">
                  <Landmark className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-xs font-semibold text-slate-500">Total Transactions</p>
                  <p className="text-2xl font-extrabold text-slate-200">{statsQuery.data?.totalTransactions || 0}</p>
                </div>
              </Card>
              <Card className="p-5 border-slate-800 bg-slate-900/60 backdrop-blur-md flex items-center space-x-4 hover:border-sky-500/30 transition-colors">
          ...
          <Card className="p-6 border-slate-800 bg-slate-900/60">
            <h3 className="text-sm font-bold text-slate-200 mb-4">Server & Service Health</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              {[
                ...
                <div key={label} className="flex items-center justify-between p-3 rounded-xl bg-slate-950/20 border border-slate-800">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            <div className="relative flex-1 w-full sm:max-w-sm">
              ...
              <input
                ...
                className="w-full py-2.5 pl-9 pr-9 rounded-xl bg-slate-800 border border-slate-700 text-slate-100 placeholder-slate-500 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
              />
              {search && (
                      ...
                      <tr key={u.id} className="hover:bg-slate-800/20 transition-colors group">
                        ...
                        <td className="py-3.5 px-5">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-semibold text-slate-200 text-[13px]">{u.firstName} {u.lastName}</p>
            ...
            {usersPagination && usersPagination.totalPages > 1 && (
              <div className="flex items-center justify-between px-5 py-3 border-t border-slate-800 text-xs text-slate-500">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-semibold text-slate-300">{usersPage} / {usersPagination.totalPages}</span>
                  <button
                  ...
                  {auditLogs.map((log) => (
                    <tr key={log.id} className="hover:bg-slate-800/20 transition-colors">
                      ...
                      <td className="py-3 px-4">
                        {log.user ? (
                          <span className="text-slate-300 font-semibold">{log.user.firstName} {log.user.lastName}</span>
                        ) : (
          ...
          {auditPagination && auditPagination.totalPages > 1 && (
            <div className="flex items-center justify-between px-5 py-3 border-t border-slate-800 text-xs text-slate-500">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-slate-300">{logsPage} / {auditPagination.totalPages}</span>
                <button

      ...
      <div className="flex items-center gap-3 flex-1">
        ...
        {editing ? (
          <input
            ...
            min="0.0001"
            autoFocus
            className="w-40 px-3 py-1.5 rounded-lg bg-slate-800 border border-violet-500/60 text-slate-100 text-sm font-mono focus:outline-none focus:ring-1 focus:ring-violet-500"
          />
        ) : (
  ...
  if (!open) {
    return (
      <button
        ...
        className="w-full flex items-center justify-center gap-2 px-5 py-4 rounded-xl border border-dashed border-slate-700 text-slate-500 hover:text-violet-400 hover:border-violet-500/50 hover:bg-violet-500/5 transition-all duration-200 text-sm font-medium"
      >
    ...
    <div className="flex flex-wrap items-end gap-3 px-5 py-4 rounded-xl border border-violet-500/50 bg-violet-500/5">
      <div className="flex flex-col gap-1">
        ...
        <input
          ...
          className="w-20 px-3 py-2 rounded-lg bg-slate-800 border border-slate-700 text-slate-100 text-sm font-mono uppercase focus:outline-none focus:border-violet-500"
        />
      </div>
      <div className="flex flex-col gap-1">
        ...
        <input
          ...
          className="w-28 px-3 py-2 rounded-lg bg-slate-800 border border-slate-700 text-slate-100 text-sm font-mono uppercase focus:outline-none focus:border-violet-500"
        />
      </div>
      <div className="flex flex-col gap-1 flex-1 min-w-[120px]">
        ...
        <input
          ...
          className="w-full px-3 py-2 rounded-lg bg-slate-800 border border-slate-700 text-slate-100 text-sm font-mono focus:outline-none focus:border-violet-500"
        />
      </div>
      <button
        onClick={handleSave}
      ...
      <button
        ...
        className="px-4 py-2 rounded-lg bg-slate-800 text-slate-400 text-sm font-semibold hover:text-slate-200 hover:bg-slate-700 transition-colors"
      >
        Cancel
      </button>
    </div>
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        action={
          <div className="flex items-center gap-2 text-[11px] text-slate-500 bg-slate-900/60 border border-slate-800 px-3 py-2 rounded-lg">
      ...
      <Card className="flex items-start gap-3 py-4 px-5 border-amber-500/30 bg-amber-500/5">
        ...
        <div className="text-[13px] text-slate-400 leading-relaxed">
          ...
          each account's balance into your <strong className="text-slate-200">profile base currency</strong> before
      ...
      <Card className="p-0 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-800/60">
          <div>
            <h2 className="text-sm font-bold text-slate-100">Configured Rates</h2>
            ...
            <div className="pt-2">
              ...
              {missingCurrencies.map((code) => {
                ...
                return (
                  <div
                    key={code}
                    className="flex items-center gap-4 px-5 py-3 rounded-xl border border-dashed border-slate-800 opacity-50"
                  >
                    <span className="text-2xl">{meta.flag}</span>
                    <div className="flex-1">
                      <p className="text-sm font-bold text-slate-400">{code}</p>
...
function QuickConverter({ rates }: { rates: ExchangeRate[] }) {
  ...
  return (
    <Card>
      <h3 className="text-sm font-bold text-slate-100 mb-4">Quick Converter</h3>
      <div className="flex flex-wrap items-end gap-3">
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className="w-32 px-3 py-2 rounded-lg bg-slate-800 border border-slate-700 text-slate-100 text-sm font-mono focus:outline-none focus:border-violet-500"
          />
        </div>
        <div className="flex flex-col gap-1">
          ...
          <select
            ...
            className="px-3 py-2 rounded-lg bg-slate-800 border border-slate-700 text-slate-100 text-sm focus:outline-none focus:border-violet-500"
          >

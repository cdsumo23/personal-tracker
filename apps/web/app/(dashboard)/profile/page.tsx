  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        {/* Navigation Sidebar */}
        <Card className="p-4 border-slate-800 bg-slate-900/60 backdrop-blur-md lg:h-fit space-y-1">
          <button
        ...
        {/* Form panel */}
        <Card className="lg:col-span-3 p-6 border-slate-800 bg-slate-900/60 backdrop-blur-md">
          ...
          {activeTab === 'preferences' && (
            <div className="space-y-6">
              ...
              <div className="space-y-4 max-w-md">
                <div className="flex items-center justify-between p-4 rounded-xl border border-slate-800 bg-slate-950/20">
                  <div>
                    <span className="text-sm font-semibold text-slate-200 block">Dark Theme Mode</span>
              ...
              <h3 className="text-base font-bold text-slate-200 border-b border-slate-800 pb-3 pt-6 flex items-center">
              ...
              <div className="space-y-4 max-w-md">
                {!push.isSupported ? (
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 rounded-xl border border-slate-800 bg-slate-950/20">
                      <div>
                        <span className="text-sm font-semibold text-slate-200 block">Push Alerts Status</span>
          ...
          {activeTab === 'data' && (
            <div className="space-y-6">
              ...
              <div className="space-y-5">
                <div className="p-4 rounded-xl border border-slate-800 bg-slate-950/10 space-y-3">
                  <h4 className="text-sm font-semibold text-slate-200">Download Full Local Backup</h4>
                ...
                <div className="p-4 rounded-xl border border-slate-800 bg-slate-950/10 space-y-3">
                  <h4 className="text-sm font-semibold text-slate-200">Restore System Backup</h4>
                  <p className="text-xs text-slate-500 leading-normal">

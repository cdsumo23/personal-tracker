...
export function FinancialHealthScore({ score, className }: FinancialHealthScoreProps) {
 ...
 return (
 <Card className={cn('flex flex-col sm:flex-row items-center gap-6 hover:border-slate-300 dark:border-slate-700/60', className)}>
 {/* Circular Gauge */}
 ...
 <span className="text-2xl font-black text-slate-900 dark:text-slate-100 tracking-tight">{score}</span>

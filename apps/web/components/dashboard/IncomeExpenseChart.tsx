...
export function IncomeExpenseChart() {
 ...
 return (
 <div className="bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 p-3 rounded-xl shadow-xl backdrop-blur-md">
 <p className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-2">{payload[0].payload.month}</p>
 <div className="space-y-1 text-xs">
 <p className="flex justify-between items-center gap-4">
 <span className="text-emerald-400 font-medium">Income:</span>
 <span className="font-extrabold text-slate-900 dark:text-slate-100">{format(payload[0].value)}</span>
 </p>
 <p className="flex justify-between items-center gap-4">
 <span className="text-rose-400 font-medium">Expenses:</span>
 <span className="font-extrabold text-slate-900 dark:text-slate-100">{format(payload[1].value)}</span>
 </p>
 <p className="flex justify-between items-center gap-4 border-t border-slate-200 dark:border-slate-800 pt-1 mt-1">
 ...
 <p className="text-xs font-extrabold text-slate-800 dark:text-slate-200">{format(totalIncome)}</p>
 </div>
 </div>
 <div className="flex items-center gap-2">
 ...
 <p className="text-xs font-extrabold text-slate-800 dark:text-slate-200">{format(totalExpense)}</p>
 </div>
 </div>
 </div>
 </div>

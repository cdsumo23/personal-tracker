...
export function InsightCards() {
 ...
 <Card
 key={insight.id}
 className={cn('flex gap-3 p-4 hover:border-slate-300 dark:border-slate-700/60 transition-all duration-300', cfg.border)}
 >
 ...
 <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">{insight.description}</p>
 </div>
 </Card>
 );
 })}

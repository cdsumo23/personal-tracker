            ...
            <>
              ...
              <div className="absolute right-0 mt-2.5 w-48 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xl p-2 z-40">
                <button
                  ...
                  className="flex items-center gap-2.5 w-full px-3.5 py-2.5 rounded-lg text-xs font-semibold text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-850 transition-colors touch-target"
                >

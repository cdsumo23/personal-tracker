    ...
    <AnimatePresence>
      <div className="fixed bottom-4 left-4 right-4 z-50 md:left-auto md:max-w-md">
        <motion.div
          ...
          className="relative overflow-hidden rounded-2xl border border-slate-800 bg-slate-900/90 p-5 shadow-2xl backdrop-blur-lg flex flex-col gap-4"
        >
          ...
          <button
            ...
            className="absolute top-3 right-3 p-1 rounded-lg text-slate-400 hover:text-slate-200 hover:bg-slate-800/60 transition-colors"
          >
            <X className="w-4 h-4" />
          </button>
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div className="space-y-1 pr-6">
              <h4 className="text-sm font-bold text-slate-100">Install Smart Planner Shortcut</h4>
            ...
            {isIos ? (
              ...
              <div className="flex flex-col gap-2.5 text-xs text-slate-300">
                <div className="flex items-center gap-2">
                  <span className="flex items-center justify-center w-5 h-5 rounded-full bg-slate-800 border border-slate-700 text-[10px] font-bold text-slate-200">1</span>
                  <span>Tap the **Share** button <Share className="w-3.5 h-3.5 inline text-primary-400 mx-0.5" /> in Safari.</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="flex items-center justify-center w-5 h-5 rounded-full bg-slate-800 border border-slate-700 text-[10px] font-bold text-slate-200">2</span>
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  onClick={handleDismiss}
                  className="py-2 px-4 rounded-xl border border-slate-800 hover:bg-slate-800/50 text-xs font-bold text-slate-400 hover:text-slate-200 transition-colors"
                >
                  Not Now
                </button>
              </div>

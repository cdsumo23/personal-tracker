...
export function NotificationDropdown() {
 ...
 <button
 type="button"
 className="relative p-2.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/60 hover:bg-slate-700/60 text-slate-600 dark:text-slate-300 hover:text-white transition-colors focus:outline-none"
 >
 ...
 align="end"
 sideOffset={8}
 className="z-50 w-80 max-h-[420px] flex flex-col rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-900 shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150"
 >
 {/* Header */}
 <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 dark:border-slate-850 bg-slate-900/60">
 ...
 <p className={cn('text-xs text-slate-800 dark:text-slate-200 leading-normal', !n.isRead && 'font-semibold')}>
 {n.message}
 </p>
